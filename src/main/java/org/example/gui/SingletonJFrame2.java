...
public class SingletonJFrame2 extends JFrame {
    ...
    private static SingletonJFrame2 instance;
    ...
    public static SingletonJFrame2 getInstance() {
        if (instance == null) {
            instance = new SingletonJFrame2();
        }
        return instance;
    }
...
//        buttonsPanel.setLayout(new BoxLayout(buttonsPanel, BoxLayout.Y_AXIS));
        createStatsButton("جدول 6 : الانتفاع بمشروع صغير (رجال و نساء رؤساء العائلات)", () -> new Tab6Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 14 : حالة المسكن", () -> new Tab14Frame(this.selectedGouvernorat, this.selectedDelegation, this.selectedSecteur, this.selectedComplexeRes));
        createStatsButton("جدول 15 : منتفع بماجل", () -> new Tab15Frame(this.selectedGouvernorat, this.selectedDelegation, this.selectedSecteur, this.selectedComplexeRes));
        createStatsButton("جدول 16 : التزود بالماء الصالح للشراب", () -> new Tab16Frame(this.selectedGouvernorat, this.selectedDelegation, this.selectedSecteur, this.selectedComplexeRes));
