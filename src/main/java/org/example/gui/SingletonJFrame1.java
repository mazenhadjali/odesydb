...
public class SingletonJFrame1 extends JFrame {
    ...
    private static SingletonJFrame1 instance;
    ...
    public static SingletonJFrame1 getInstance() {
        if (instance == null) {
            instance = new SingletonJFrame1();
        }
        return instance;
    }
...
//        buttonsPanel.setLayout(new BoxLayout(buttonsPanel, BoxLayout.Y_AXIS));
        createStatsButton(" جدول 1 : رؤساء العائلات", () -> new Tab1Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 2 : المستوى التعليمي (رجال و نساء رؤساء العائلات)", () -> new Tab2Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 3 : النشاط الرئيسي (رجال و نساء رؤساء العائلات)", () -> new Tab3Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 4 : الحالة الاجتماعية (رجال و نساء رؤساء العائلات)", () -> new Tab4Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 7 : المستوى التعليمي للقرين  (الزوج / الزوجة)", () -> new Tab7Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 8 : النشاط الرئيسي للقرين  (الزوج / الزوجة)", () -> new Tab8Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 9 : المهارات للقرين  (الزوج / الزوجة)", () -> new Tab9Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 10 : عدد الأشخاص  ذوي الاحتياجات الخصوصية", () -> new Tab10Frame(selectedGouvernorat, selectedDelegation, selectedSecteur, selectedComplexeRes));
        createStatsButton("جدول 11 : الشباب حسب العمر", () -> new Tab11Frame(this.selectedGouvernorat, this.selectedDelegation, this.selectedSecteur, this.selectedComplexeRes));
        createStatsButton("جدول 12 : بصدد الدراسة", () -> new Tab12Frame(this.selectedGouvernorat, this.selectedDelegation, this.selectedSecteur, this.selectedComplexeRes));
